...
public class TCPDefinition extends PersistentResourceDefinition {
    protected static final SimpleAttributeDefinition HIGH_WATER_MARK = new SimpleAttributeDefinitionBuilder(
    ...
    protected static final SimpleAttributeDefinition NUMBER_TO_RECLAIM = new SimpleAttributeDefinitionBuilder(
    ...
    private static final List<SimpleAttributeDefinition> ATTRIBUTES = Collections.unmodifiableList(Arrays.asList(
            HIGH_WATER_MARK, NUMBER_TO_RECLAIM));
    ...
    private TCPDefinition() {
        super(JdkORBExtension.PATH_TCP, JdkORBExtension.getResourceDescriptionResolver(JdkORBSubsystemConstants.ORB,
                JdkORBSubsystemConstants.ORB_TCP), new AbstractAddStepHandler(), ReloadRequiredRemoveStepHandler.INSTANCE);
    }
