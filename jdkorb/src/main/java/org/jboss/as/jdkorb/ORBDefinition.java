...
public class ORBDefinition extends PersistentResourceDefinition {
    protected static final SimpleAttributeDefinition PERSISTENT_SERVER_ID = new SimpleAttributeDefinitionBuilder(
    ...
    protected static final SimpleAttributeDefinition GIOP_VERSION = new SimpleAttributeDefinitionBuilder(
    ...
    protected static final SimpleAttributeDefinition SSL_SOCKET_BINDING = new SimpleAttributeDefinitionBuilder(
